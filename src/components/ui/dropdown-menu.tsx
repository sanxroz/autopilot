...
const dropdownMenuVariants = tv({
  slots: {
    ...
    subContent: [
      "z-50 min-w-[8rem] overflow-hidden rounded-md border border-neutral-200 bg-white p-1 text-neutral-950 shadow-lg",
      "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
      "dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50",
    ],
...
const { content, item, checkboxItem, radioItem, label, separator, shortcut, subTrigger, subContent, itemIndicator } = dropdownMenuVariants()
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={subTrigger({ class: [inset && "pl-8", className] })}
    {...props}
  >
    {children}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={item({ class: [inset && "pl-8", className] })}
    {...props}
  />
))
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={label({ class: [inset && "pl-8", className] })}
    {...props}
  />
))
...
const DropdownMenuShortcut = ({
  ...
  return <span className={shortcut({ class: className })} {...props} />
}
